...
| 5 | `CODEX_SETUP.md` | AGENTS.md, MCP, Codex commands |
...
- "Set up Codex for my Rails project"

## Next Steps

After MVP docs are complete:
- Use pitch workflow to create investor materials
